...
- [ ] The offline checks pass: `node tools/smoke-plugin.mjs`, `node tools/jev-verdict.mjs selftest`, `node tools/route.mjs selftest`, `node tools/route.mjs regress --file cases/route-cases-neutral.json`, `node tools/route.mjs arms`.
